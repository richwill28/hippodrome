...
struct Engine {
  ...
  std::unordered_set<Event>
  annotate_trickle_down_summary(Transaction Ti, Nonterminal A, Nonterminal B,
                                const std::unordered_set<Event> &summary) {
  ...
  std::unordered_set<Event> annotate_trickle_down_reversed_summary(
      Transaction Ti, Nonterminal A, Nonterminal C,
      const std::unordered_set<Event> &summary) {
  ...
  std::unordered_set<Event>
  annotate_b_reversed_summary(Transaction Ti, Nonterminal A, Nonterminal C,
                              const std::unordered_set<Event> &summary) {
  ...
  std::unordered_set<Event> compute_trickle_up_reversed_summary_fixpoint(
    ...
    std::unordered_set<Event> annotated_trickle_down_reversed_summary =
        annotate_trickle_down_reversed_summary(Tj, A, C,
                                               trickle_down_reversed_summary);
  ...
  void compute_reversed_summary(
    ...
    std::unordered_set<Event> annotated_trickle_down_reversed_summary =
        annotate_trickle_down_reversed_summary(Ti, A, C,
                                               trickle_down_reversed_summary);
