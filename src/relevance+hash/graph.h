...
struct Graph {
  ...
  std::unordered_map<Transaction, ankerl::unordered_dense::set<Event>> content;
  std::unordered_map<Transaction, ankerl::unordered_dense::set<Event>> summary;
  std::unordered_map<Transaction, ankerl::unordered_dense::set<Event>>
      reversed_summary;
  ...
  bool cyclic() const {
    std::unordered_map<Transaction, ankerl::unordered_dense::set<Transaction>>
        neighbors;
