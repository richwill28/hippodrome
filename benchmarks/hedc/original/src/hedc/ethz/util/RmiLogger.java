 ...
 * All rights reserved
 * 
 * $Id: RmiLogger.java,v 1.1 2001/03/16 18:15:21 praun Exp $
 * 
 * 28/03/99  cvp 
 *
 */
 
package hedc.ethz.util;
...
public class RmiLogger extends Logger {
    ...
    private static final String LOG_ID_ = "$Id: RmiLogger.java,v 1.1 2001/03/16 18:15:21 praun Exp $";
